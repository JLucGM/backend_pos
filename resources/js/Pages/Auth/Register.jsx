                ...
                return (
                    <div className="space-y-6">
                        {/* <div className="flex items-center justify-between mb-4">
                            ...
                            <Button type="button" variant="outline" size="sm" onClick={() => setShowPlans(!showPlans)}>
                        ...
                        <div className="bg-gray-50 p-6 rounded-lg space-y-4">
                            <div>
                                ...
                                <div className="space-y-2 text-sm">
                                    ...
                                    <p>
                                        <span className="font-medium">Avatar:</span> {data.avatar ? data.avatar.name : 'No seleccionado'}
                                    </p>
                                </div>
                            </div>
                            <div>
                                ...
                                <div className="space-y-2 text-sm">
                                    <p>
                                        <span className="font-medium">Nombre:</span> {data.company_name}
                                    </p>
                                </div>
                            </div>
                            <div>
                                        ...
                                        <div className="bg-green-50 p-3 rounded">
                                            ...
                                            {!selectedPlan.is_trial && (
                                                <p>
                                                    ...
                                                    / {data.billing_cycle === 'yearly' ? 'año' : 'mes'}
                                                </p>
                                            )}
                                        </div>
                                    ) : (
                ...
                <div className="flex items-center justify-between pt-6 border-t">
                    ...
                    <div className="flex items-center gap-3">
                        {currentStep < steps.length - 1 ? (
                            ...
                            <PrimaryButton type="submit" disabled={processing} className="px-6">
