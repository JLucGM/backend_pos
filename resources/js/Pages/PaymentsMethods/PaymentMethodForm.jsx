        ...
        <>
            ...
            {data.payment_details.map((detail, index) => (
                <div key={index} className="grid grid-cols-3 gap-4">
                    <div>
                        <InputLabel htmlFor={`payments_method_details_data_types_${index}`} value="Data Type" />
                        <TextInput
                    ...
                    <div>
                        <InputLabel htmlFor={`payments_method_details_value_${index}`} value="Value" />
                        <TextInput
                    ...
                    <div className="flex items-end">
                        <Button type="button" onClick={() => removePaymentDetail(index)}>
                            Eliminar
                        </Button>
                    </div>
                </div>
