...
const CarouselTitleEditDialog = ({ 
    ...
    const resetToDefaults = () => {
        setEditStyles(prev => ({
            ...
            fontWeight: themeSettings?.heading2_fontWeight || 'bold',
            lineHeight: themeSettings?.heading2_lineHeight || '1.2',
            textTransform: themeSettings?.heading2_textTransform || 'none',
            fontType: 'default',
            customFont: '',
        }));
    };
    ...
    return (
        <div className="space-y-4">
            ...
            <div>
                <Label htmlFor="titleContent">Título del Carrusel</Label>
                <Input
                    id="titleContent"
                    value={editContent}
