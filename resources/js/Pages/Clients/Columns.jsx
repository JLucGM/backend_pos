...
export const userColumns = [
    ...
    },
    {
        ...
        cell: ({ row, table }) => {
            ...
            const canEdit = isSuperAdmin || permissions.includes('admin.client.edit');
            const canDelete = isSuperAdmin || permissions.includes('admin.client.delete');
                    ...
                    <DropdownMenuContent>
                        ...
                        {canDelete && (
                            <DropdownMenuItem onSelect={(e) => e.preventDefault()}>
                                <ConfirmDeleteDialog url={route('client.destroy', [row.original])} />
                            </DropdownMenuItem>
                        )}
                    </DropdownMenuContent>
                </DropdownMenu>
