...
class CheckoutController extends Controller
{
    ...
    /**
     * Crear nueva dirección de entrega desde el checkout
     */
    ...
    /**
     * Actualizar dirección de entrega desde el checkout
     */
    public function updateAddress(Request $request, $subdomain, DeliveryLocation $deliveryLocation)
    {
        $user = Auth::user();
    ...
    /**
     * Eliminar dirección de entrega desde el checkout
     */
    public function destroyAddress($subdomain, DeliveryLocation $deliveryLocation)
    {
        $user = Auth::user();
